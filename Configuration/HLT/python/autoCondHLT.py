...
l1Menus = {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2023_v1_3_0_ADTv3Updated_xml'           ,l1tMenuRecord,connectionString,l1tMenuLabel, "2024-02-07 15:33:37.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2023_v1_3_0_ADTv3Updated_xml'           ,l1tMenuRecord,connectionString,l1tMenuLabel, "2024-02-07 15:33:37.000"] ), ),
    ...
    'Special'      : ( ','.join( [ 'L1Menu_Collisions2023_v1_3_0_ADTv3Updated_xml'           ,l1tMenuRecord,connectionString,l1tMenuLabel, "2024-02-07 15:33:37.000"] ), ),
}
