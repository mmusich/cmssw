...
pixelGains = {
    'GRun'         : ( ','.join ( [ 'SiPixelGainCalibrationHLT_2009runs_ScaledForVCal_hlt'   ,"SiPixelGainCalibrationForHLTRcd","frontier://FrontierPrep/CMS_CONDITIONS","", "2020-07-17 10:15:00.000"] ), ),
}
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run3_hlt_GRun'          : ('run2_hlt_relval'         ,l1Menus['GRun']+pixelGains['GRun']),
