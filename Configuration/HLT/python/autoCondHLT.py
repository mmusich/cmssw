...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2017_v3_m6_xml'                         ,l1tMenuRecord,connectionString,l1tMenuLabel, "2017-07-24 12:50:00.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2017_v3_m6_xml'                         ,l1tMenuRecord,connectionString,l1tMenuLabel, "2017-07-24 12:50:00.000"] ), ),
    '2e34v22'      : ( ','.join( [ 'L1Menu_Collisions2017_v2_m6_full_xml'                    ,l1tMenuRecord,connectionString,l1tMenuLabel, "2017-07-08 11:46:40.000"] ), ),
    '2e34v30'      : ( ','.join( [ 'L1Menu_Collisions2017_v3_m6_xml'                         ,l1tMenuRecord,connectionString,l1tMenuLabel, "2017-07-24 12:50:00.000"] ), ),
...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run2_hlt_2e34v30'       : ('run2_hlt_relval'      ,l1Menus['2e34v30']),
    ...
    'run2_data_2e34v30'      : ('run2_data_promptlike' ,l1Menus['2e34v30']),
