#!/usr/bin/env python3
"""
_ppEra_Run3_2017_trackingLowPU_
...
from Configuration.Eras.Era_Run3_trackingLowPU_cff import Run3_trackingLowPU

from Configuration.DataProcessing.Impl.pp import pp

class ppEra_Run3_trackingLowPU(pp):
    def __init__(self):
        pp.__init__(self)
        self.recoSeq=''
        self.cbSc='pp'
        self.addEI=True
        self.eras=Run3_trackingLowPU
