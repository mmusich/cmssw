...
steps['Cosmics_Phase2']=merge([{'cfg':'UndergroundCosmicMu_cfi.py','-n':'500','--conditions':'auto:phase2_realistic','--scenario':'cosmics','--era':'Phase2C17I13M9','--geometry':'Extended2026D88'},Kby(666,100000),step1Defaults])
...
steps['DIGICOS_Phase2']=merge([{'--conditions':'auto:phase2_realistic','-s':'DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@fake2','--scenario':'cosmics','--eventcontent':'FEVTDEBUG','--datatier':'GEN-SIM-DIGI-RAW', '--era' : 'Phase2C17I13M9','--geometry':'Extended2026D88'},step2Upg2015Defaults])
...
steps['RECOCOS_Phase2']=merge([{'--conditions':'auto:phase2_realistic','-s':'RAW2DIGI,L1Reco,RECO,ALCA:MuAlGlobalCosmics,DQM:@cosmics','--scenario':'cosmics','--era':'Phase2C17I13M9','--geometry':'Extended2026D88'},step3Up2015Hal])
...
steps['ALCACOS_Phase2']=merge([{'--conditions':'auto:phase2_realistic','--era':'Phase2C17I13M9','-s':'ALCA:SiPixelCalCosmics+TkAlCosmics0T+DQM'},steps['ALCACOSD']])
