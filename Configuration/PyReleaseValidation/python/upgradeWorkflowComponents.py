...
upgradeProperties[2026] = {
    ...
    '2026D64' : {
        ...
        'ProcessModifier': 'PixelCPEGeneric,phase2_SquarePixels',  # This swaps template reco CPE for generic reco CPE, customizes for square pixels
        'Era' : 'Phase2C11',
        'ScenToRun' : ['GenSimHLBeamSpot','DigiTrigger','RecoGlobal', 'HARVESTGlobal'],
    },
    '2026D65' : {
        ...
        'ProcessModifier': 'PixelCPEGeneric,phase2_3DPixels',  # This swaps template reco CPE for generic reco CPE, customizes for 3D pixels
        'Era' : 'Phase2C11',
        'ScenToRun' : ['GenSimHLBeamSpot','DigiTrigger','RecoGlobal', 'HARVESTGlobal'],
    },
    '2026D66' : {
