...
static constexpr auto s_tag = "[PixelClusterCounter]";

TEST_CASE("Standard checks of PixelClusterCounter", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("PixelClusterCounter"
