...
process.MessageLogger.categories.append("SiPixelQualityCollectionWriteFromASCII")  
...
process.MessageLogger.cout = cms.untracked.PSet(
    ...
    SiPixelQualityCollectionWriteFromASCII = cms.untracked.PSet( limit = cms.untracked.int32(-1)),
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
                                          ...
                                          toPut = cms.VPSet(cms.PSet(record = cms.string('SiPixelStatusScenariosRcd'),
                                                                     tag = cms.string('SiPixelFEDChannelQualityContainer_StuckTBM_2018_v1_mc')
                                                                     )
                                                            )
                                          )

process.WriteInDB = cms.EDAnalyzer("SiPixelFEDChannelQualityContainerWriteFromASCII",
