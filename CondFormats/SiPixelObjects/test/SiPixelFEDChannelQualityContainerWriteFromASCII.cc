...
class SiPixelFEDChannelQualityContainerWriteFromASCII : public edm::one::EDAnalyzer<>  {
   public:
      explicit SiPixelFEDChannelQualityContainerWriteFromASCII(const edm::ParameterSet&);
      ~SiPixelFEDChannelQualityContainerWriteFromASCII();
...
//
SiPixelFEDChannelQualityContainerWriteFromASCII::SiPixelFEDChannelQualityContainerWriteFromASCII(const edm::ParameterSet& iConfig):
...
SiPixelFEDChannelQualityContainerWriteFromASCII::~SiPixelFEDChannelQualityContainerWriteFromASCII()
{
  delete myQualities;
}
...
void
SiPixelFEDChannelQualityContainerWriteFromASCII::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   ...
   SiPixelFEDChannelQualityContainer::SiPixelFEDChannelCollection theBadFEDChannels;
   ...
   if(printdebug_){
     edm::LogInfo("SiPixelFEDChannelQualityContainerWriteFromASCII")<<"Content of SiPixelFEDChannelQualityContainer "<<std::endl;
...
void 
SiPixelFEDChannelQualityContainerWriteFromASCII::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
SiPixelFEDChannelQualityContainerWriteFromASCII::endJob() 
{

  edm::LogInfo("SiPixelFEDChannelQualityContainerWriteFromASCII")<<"Size of SiPixelFEDChannelQualityContainer object "<< myQualities->size() <<std::endl<<std::endl;
...
DEFINE_FWK_MODULE(SiPixelFEDChannelQualityContainerWriteFromASCII);
