...
void EcalDetailedTimeRecHitProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<edm::InputTag>("EBRecHitCollection", edm::InputTag("ecalRecHit", "EcalRecHitsEE"));
  desc.add<edm::InputTag>("EERecHitCollection", edm::InputTag("ecalRecHit", "EcalRecHitsEB"));
  desc.add<edm::InputTag>("EBTimeDigiCollection", edm::InputTag("mix", "EETimeDigi"));
  desc.add<edm::InputTag>("EETimeDigiCollection", edm::InputTag("mix", "EBTimeDigi"));
