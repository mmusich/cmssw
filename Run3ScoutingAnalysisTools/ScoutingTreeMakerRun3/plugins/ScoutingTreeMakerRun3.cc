...
void ScoutingTreeMakerRun3::beginJob() {
  ...
  tree->Branch(
      "nTrackerLayersWithMeasurement1_mu", &nTrackerLayersWithMeasurement1_mu, "nTrackerLayersWithMeasurement1_mu/I");
  tree->Branch(
      "nTrackerLayersWithMeasurement2_mu", &nTrackerLayersWithMeasurement2_mu, "nTrackerLayersWithMeasurement2_mu/I");
  ...
  nTrackerLayersWithMeasurement1_mu_hist =
      fs->make<TH1I>("nTrackerLayersWithMeasurement1_mu", "Tracker Layers 1; Layers; Entries", 20, 0, 20);
  nTrackerLayersWithMeasurement2_mu_hist =
      fs->make<TH1I>("nTrackerLayersWithMeasurement2_mu", "Tracker Layers 2; Layers; Entries", 20, 0, 20);
  ...
  diele_hist = fs->make<TH1F>("dieleMass", "Dielectron mass; Mass (GeV); Entries", 100, 0.0, 120.0);
  pt_diele_hist = fs->make<TH1F>("pt_diele", "Dielectron pT; pT (GeV); Entries", 100, 0.0, 100.0);
  ...
  preshowerEnergy_ele_hist =
      fs->make<TH1F>("preshowerEnergy_ele", "Preshower Energy; Energy (GeV); Entries", 100, 0.0, 10.0);
  corrEcalEnergyError_ele_hist = fs->make<TH1F>(
  ...
  sigmaIetaIeta_ele_hist =
      fs->make<TH1F>("sigmaIetaIeta_ele", "Sigma iEta iEta; #sigma_{i#eta i#eta}; Entries", 100, 0.0, 0.05);
  ...
  preshowerEnergy_pho_hist =
      fs->make<TH1F>("preshowerEnergy_pho", "Preshower Energy; Energy (GeV); Entries", 100, 0.0, 10.0);
  corrEcalEnergyError_pho_hist = fs->make<TH1F>(
      "corrEcalEnergyError_pho", "Corrected ECAL Energy Error; Energy Error (GeV); Entries", 100, 0.0, 5.0);
  sigmaIetaIeta_pho_hist =
      fs->make<TH1F>("sigmaIetaIeta_pho", "Sigma iEta iEta; #sigma_{i#eta i#eta}; Entries", 100, 0.0, 0.05);
  ...
  chargedHadronEnergy_PFJ_hist =
      fs->make<TH1F>("chargedHadronEnergy_PFJ", "Charged Hadron Energy; Energy (GeV); Entries", 100, 0.0, 500.0);
  neutralHadronEnergy_PFJ_hist =
      fs->make<TH1F>("neutralHadronEnergy_PFJ", "Neutral Hadron Energy; Energy (GeV); Entries", 100, 0.0, 5000.0);
  ...
  electronEnergy_PFJ_hist =
      fs->make<TH1F>("electronEnergy_PFJ", "Electron Energy; Energy (GeV); Entries", 100, 0.0, 100.0);
  muonEnergy_PFJ_hist = fs->make<TH1F>("muonEnergy_PFJ", "Muon Energy; Energy (GeV); Entries", 100, 0.0, 200.0);
  HFHadronEnergy_PFJ_hist =
      fs->make<TH1F>("HFHadronEnergy_PFJ", "HF Hadron Energy; Energy (GeV); Entries", 100, 0.0, 5000.0);
  ...
  chargedHadronMultiplicity_PFJ_hist =
      fs->make<TH1F>("chargedHadronMultiplicity_PFJ", "Charged Hadron Multiplicity; Multiplicity; Entries", 50, 0, 50);
  neutralHadronMultiplicity_PFJ_hist =
      fs->make<TH1F>("neutralHadronMultiplicity_PFJ", "Neutral Hadron Multiplicity; Multiplicity; Entries", 50, 0, 50);
  photonMultiplicity_PFJ_hist =
      fs->make<TH1F>("photonMultiplicity_PFJ", "Photon Multiplicity; Multiplicity; Entries", 50, 0, 50);
  electronMultiplicity_PFJ_hist =
      fs->make<TH1F>("electronMultiplicity_PFJ", "Electron Multiplicity; Multiplicity; Entries", 20, 0, 20);
  muonMultiplicity_PFJ_hist =
      fs->make<TH1F>("muonMultiplicity_PFJ", "Muon Multiplicity; Multiplicity; Entries", 20, 0, 20);
  HFHadronMultiplicity_PFJ_hist =
      fs->make<TH1F>("HFHadronMultiplicity_PFJ", "HF Hadron Multiplicity; Multiplicity; Entries", 50, 0, 50);
  HFEMMultiplicity_PFJ_hist =
      fs->make<TH1F>("HFEMMultiplicity_PFJ", "HF EM Multiplicity; Multiplicity; Entries", 50, 0, 50);
  ...
  mvaDiscriminator_PFJ_hist =
      fs->make<TH1F>("mvaDiscriminator_PFJ", "MVA Discriminator; MVA Score; Entries", 100, -1.0, 1.0);
