// -*- C++ -*-
//
// Package:    SiStripConditionAnalysis/SiStripChannelGainMultiIOVFixer
// Class:      SiStripChannelGainMultiIOVFixer
// 
/**\class SiStripChannelGainMultiIOVFixer SiStripChannelGainMultiIOVFixer.cc SiStripConditionAnalysis/SiStripChannelGainMultiIOVFixer/plugins/SiStripChannelGainMultiIOVFixer.cc
...
void
SiStripChannelGainMultiIOVFixer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
SiStripChannelGainMultiIOVFixer::beginJob()
{
...
void 
SiStripChannelGainMultiIOVFixer::endJob() 
{
...
SiStripChannelGainMultiIOVFixer::typeAndLayerFromDetId( const DetId& detId , const TrackerTopology* tTopo) const
{
...
// -------------- method to get the topology from the detID ------------------------------
std::string 
SiStripChannelGainMultiIOVFixer::getStringFromEnum(partitions::layers e)
{
  switch(e)
    {
...
void
SiStripChannelGainMultiIOVFixer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
