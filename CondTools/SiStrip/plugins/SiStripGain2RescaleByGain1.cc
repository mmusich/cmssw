...
// Class:      SiStripGain2RescaleByGain1
// 
/**\class SiStripGain2RescaleByGain1 SiStripGain2RescaleByGain1.cc CondTools/SiStrip/plugins/SiStripGain2RescaleByGain1.cc
...
class SiStripGain2RescaleByGain1 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit SiStripGain2RescaleByGain1(const edm::ParameterSet&);
      ~SiStripGain2RescaleByGain1();
...
//
SiStripGain2RescaleByGain1::SiStripGain2RescaleByGain1(const edm::ParameterSet& iConfig)
{
...
SiStripGain2RescaleByGain1::~SiStripGain2RescaleByGain1()
{
...
void
SiStripGain2RescaleByGain1::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   ...
   for (const auto & d : detid) {
     ...
     for(int it=0;it<rangeG1_old.second-rangeG1_old.first;it++){
       ...
       float G1G2 = G1_old*G2_old;
       float NewGain = G1G2/g3Handle_->getApvGain(it,rangeG1_new);
...
void 
SiStripGain2RescaleByGain1::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
SiStripGain2RescaleByGain1::endJob() 
{
}

//********************************************************************************//
std::unique_ptr<SiStripApvGain>
SiStripGain2RescaleByGain1::getNewObject(const std::map<std::pair<uint32_t,int>,float>& theMap) 
{
  ...
  for(const auto &element : theMap){
    ...
    edm::LogInfo("SiStripGain2RescaleByGain1")<<" DetId: "<<DetId 
...
void
SiStripGain2RescaleByGain1::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(SiStripGain2RescaleByGain1);
