...
void
SiStripChannelGainTrendPlotter::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
SiStripChannelGainTrendPlotter::beginJob()
{
...
void 
SiStripChannelGainTrendPlotter::endJob() 
{
...
SiStripChannelGainTrendPlotter::typeAndLayerFromDetId( const DetId& detId , const TrackerTopology* tTopo) const
{
...
// -------------- method to get the topology from the detID ------------------------------
std::string 
SiStripChannelGainTrendPlotter::getStringFromEnum(partitions::layers e)
{
  switch(e)
    {
...
void
SiStripChannelGainTrendPlotter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
