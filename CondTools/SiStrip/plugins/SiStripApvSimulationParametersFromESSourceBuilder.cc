...
class SiStripApvSimulationParametersFromESSourceBuilder : public edm::one::EDAnalyzer<> {
public:
  explicit SiStripApvSimulationParametersFromESSourceBuilder(const edm::ParameterSet& iConfig) {}
  ~SiStripApvSimulationParametersFromESSourceBuilder() override {}

  void analyze(const edm::Event&, const edm::EventSetup&) override;
};

void SiStripApvSimulationParametersFromESSourceBuilder::analyze(const edm::Event&, const edm::EventSetup& evtSetup) {
  ...
  if (mydbservice.isAvailable()) {
    ...
    edm::LogError("SiStripApvSimulationParametersFromESSourceBuilder") << "Service is unavailable";
  }
}

#include "FWCore/PluginManager/interface/ModuleDef.h"
#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(SiStripApvSimulationParametersFromESSourceBuilder);
