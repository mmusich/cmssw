...
process.get = cms.EDAnalyzer("EventSetupRecordDataGetter",
                             toGet = cms.VPSet(cms.PSet(record = cms.string('SiStripApvSimulationParametersRcd'),
                                                        data = cms.vstring('SiStripApvSimulationParameters')
                                                        )
                                               ),
                             verbose = cms.untracked.bool(True)
                             )

process.prod = cms.EDAnalyzer("SiStripApvSimulationParametersFromESSourceBuilder")
process.p = cms.Path(process.prod+process.get)
