...
static constexpr auto s_tag = "[pixelOnlineToOffline]";

TEST_CASE("Standard checks of pixelOnlineToOffline", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("pixelOnlineToOffline"
