...
// Class:      TestReadPhase2Scouting
//
/**\class edmtest::TestReadPhase2Scouting
...
namespace edmtest {
  ...
  class TestReadPhase2Scouting : public edm::global::EDAnalyzer<> {
  public:
    TestReadPhase2Scouting(edm::ParameterSet const&);
  ...
  void TestReadPhase2Scouting::analyze(edm::StreamID, edm::Event const& iEvent, edm::EventSetup const&) const {
  ...
  void TestReadPhase2Scouting::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  void TestReadPhase2Scouting::analyzeCaloJets(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeElectrons(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeMuons(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeParticles(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzePFJets(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzePhotons(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeTracks(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeVertexes(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeEBRecHits(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeEERecHits(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::analyzeHBHERecHits(edm::Event const& iEvent) const {
  ...
  void TestReadPhase2Scouting::throwWithMessageFromConstructor(const char* msg) const {
    throw cms::Exception("TestFailure") << "TestReadPhase2Scouting constructor, " << msg;
  }

  void TestReadPhase2Scouting::throwWithMessage(const char* msg) const {
    throw cms::Exception("TestFailure") << "TestReadPhase2Scouting::analyze, " << msg;
  }

}  // namespace edmtest

using edmtest::TestReadPhase2Scouting;
DEFINE_FWK_MODULE(TestReadPhase2Scouting);
