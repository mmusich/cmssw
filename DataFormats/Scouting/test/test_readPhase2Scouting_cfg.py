...
parser = argparse.ArgumentParser(prog=sys.argv[0], description='Test Phase 2 Scouting data formats')

parser.add_argument("--inputFile", type=str, help="Input file name (default: testPhase2Scouting.root)", default="testPhase2Scouting.root")
parser.add_argument("--outputFileName", type=str, help="Output file name (default: testPhase2Scouting2.root)", default="testPhase2Scouting2.root")
...
process.testReadPhase2Scouting = cms.EDAnalyzer("TestReadPhase2Scouting",
    ...
    expectedCaloJetsValues = cms.vdouble(
        ...
        32.0),
    caloJetsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    electronsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    muonsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    particlesTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    pfJetsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    photonsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    tracksTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    vertexesTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    ebRecHitsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    eeRecHitsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD"),
    ...
    hbheRecHitsTag = cms.InputTag("phase2ScoutingProducer", "", "PROD")
)
...
process.path = cms.Path(process.testReadPhase2Scouting)
