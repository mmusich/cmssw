...
process.phase2ScoutingProducer = cms.EDProducer("TestWritePhase2Scouting",
...
process.out = cms.OutputModule("PoolOutputModule",
                               fileName = cms.untracked.string('testPhase2Scouting.root'),
                               #splitLevel = cms.untracked.int32(0) # default is 99, uncomment for split level 0
                               )

process.path = cms.Path(process.phase2ScoutingProducer)
