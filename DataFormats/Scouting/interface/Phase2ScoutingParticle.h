#ifndef DataFormats_Scouting_Phase2ScoutingParticle_h
#define DataFormats_Scouting_Phase2ScoutingParticle_h
...
class Phase2ScoutingParticle {
public:
  //constructor with values for all data fields
  Phase2ScoutingParticle(float pt,
                         float eta,
                         float phi,
                         int pdgId,
                         int vertex,
...
typedef std::vector<Phase2ScoutingParticle> Phase2ScoutingParticleCollection;

#endif  // DataFormats_Scouting_Phase2ScoutingParticle_h
