#ifndef DataFormats_Phase2ScoutingPFJet_h
#define DataFormats_Phase2ScoutingPFJet_h

#include <vector>

//class for holding PF jet information, for use in data scouting
//IMPORTANT: the content of this class should be changed only in backwards compatible ways!
class Phase2ScoutingPFJet {
public:
  //constructor with values for all data fields
  Phase2ScoutingPFJet(float pt,
                      float eta,
                      float phi,
                      float m,
                      float jetArea,
...
typedef std::vector<Phase2ScoutingPFJet> Phase2ScoutingPFJetCollection;
