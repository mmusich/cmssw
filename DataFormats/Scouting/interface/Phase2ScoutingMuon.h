#ifndef DataFormats_Scouting_Phase2ScoutingMuon_h
#define DataFormats_Scouting_Phase2ScoutingMuon_h
...
class Phase2ScoutingMuon {
public:
  //constructor with values for all data fields
  Phase2ScoutingMuon(float pt,
                     float eta,
                     float phi,
                     float m,
                     unsigned int type,
                     ...
                     Phase2ScoutingHitPatternPOD trk_hitPattern)
      : pt_(pt),
        eta_(eta),
        phi_(phi),
        m_(m),
  ...
  Phase2ScoutingHitPatternPOD const& trk_hitPattern() const { return trk_hitPattern_; }
...
private:
  ...
  Phase2ScoutingHitPatternPOD trk_hitPattern_;
};

typedef std::vector<Phase2ScoutingMuon> Phase2ScoutingMuonCollection;
