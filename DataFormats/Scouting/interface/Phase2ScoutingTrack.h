#ifndef DataFormats_Phase2ScoutingTrack_h
#define DataFormats_Phase2ScoutingTrack_h

#include <vector>

//class for holding track information, for use in data scouting
// IMPORTANT: the content of this class should be changed only in backwards compatible ways!
class Phase2ScoutingTrack {
public:
  //constructor with values for all data fields
  Phase2ScoutingTrack(float tk_pt,
                      float tk_eta,
                      float tk_phi,
                      float tk_chi2,
                      float tk_ndof,
...
typedef std::vector<Phase2ScoutingTrack> Phase2ScoutingTrackCollection;
