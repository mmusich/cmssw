#ifndef DataFormats_Phase2ScoutingCaloJet_h
#define DataFormats_Phase2ScoutingCaloJet_h

#include <vector>

//class for holding calo jet information, for use in data scouting
//IMPORTANT: the content of this class should be changed only in backwards compatible ways!
class Phase2ScoutingCaloJet {
public:
  //constructor with values for all data fields
  Phase2ScoutingCaloJet(float pt,
                        float eta,
                        float phi,
                        float m,
                        float jetArea,
...
typedef std::vector<Phase2ScoutingCaloJet> Phase2ScoutingCaloJetCollection;
