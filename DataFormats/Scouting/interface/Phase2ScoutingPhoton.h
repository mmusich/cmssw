#ifndef DataFormats_Phase2ScoutingPhoton_h
#define DataFormats_Phase2ScoutingPhoton_h
...
class Phase2ScoutingPhoton {
public:
  //constructor with values for all data fields
  Phase2ScoutingPhoton(float pt,
                       float eta,
                       float phi,
                       float m,
                       float rawEnergy,
...
typedef std::vector<Phase2ScoutingPhoton> Phase2ScoutingPhotonCollection;
