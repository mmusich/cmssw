#ifndef DataFormats_Phase2ScoutingVertex_h
#define DataFormats_Phase2ScoutingVertex_h

#include <vector>

//class for holding vertex information, for use in data scouting
//IMPORTANT: the content of this class should be changed only in backwards compatible ways!
class Phase2ScoutingVertex {
public:
  //constructor with values for all data fields
  Phase2ScoutingVertex(float x,
                       float y,
                       float z,
                       float zError,
                       float xError,
...
typedef std::vector<Phase2ScoutingVertex> Phase2ScoutingVertexCollection;
