#ifndef DataFormats_Phase2ScoutingElectron_h
#define DataFormats_Phase2ScoutingElectron_h
...
class Phase2ScoutingElectron {
public:
  //constructor with values for all data fields
  Phase2ScoutingElectron(float pt,
                         float eta,
                         float phi,
                         float m,
                         float rawEnergy,
...
typedef std::vector<Phase2ScoutingElectron> Phase2ScoutingElectronCollection;
