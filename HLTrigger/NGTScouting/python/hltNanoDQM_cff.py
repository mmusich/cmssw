...
hltNanoDQM = DQMEDAnalyzer("NanoAODDQM",
    ...
    vplots = cms.PSet(
        ...
        hltGsfTrackL1Seeded = cms.PSet(
            sels = cms.PSet(),
            plots = cms.VPSet(
                Plot1D('lambdaModeError', 'lambdaModeError', 20, 0, 0.1, 'GSF track lambdaModeError'),
                Plot1D('qoverpModeError', 'qoverpModeError', 20, 0, 0.05, 'GSF track qoverpModeError'),
                Plot1D('thetaModeError', 'thetaModeError', 20, 0, 0.1, 'GSF track thetaModeError'),
                Plot1D('etaModeError', 'etaModeError', 20, 0, 0.1, 'GSF track etaModeError'),
                Plot1D('phiModeError', 'phiModeError', 20, 0, 0.1, 'GSF track phiModeError'),
                Plot1D('ptModeError', 'ptModeError', 20, 0, 50, 'GSF track ptModeError'),
                Plot1D('chargeMode', 'chargeMode', 5, -2, 3, 'GSF track chargeMode'),
                Plot1D('lambdaMode', 'lambdaMode', 20, -1.5708, 1.5708, 'GSF track lambdaMode'),
                Plot1D('qoverpMode', 'qoverpMode', 20, -0.5, 0.5, 'GSF track qoverpMode'),
                Plot1D('thetaMode', 'thetaMode', 20, 0, 3.14159, 'GSF track thetaMode'),
                Plot1D('etaMode', 'etaMode', 20, -2.5, 2.5, 'GSF track etaMode'),
                Plot1D('phiMode', 'phiMode', 20, -3.14159, 3.14159, 'GSF track phiMode'),
                Plot1D('charge', 'charge', 5, -2, 3, 'GSF track charge'),
                Plot1D('ptMode', 'ptMode', 20, 0, 400, 'GSF track ptMode'),
                Plot1D('pxMode', 'pxMode', 20, -400, 400, 'GSF track pxMode'),
                Plot1D('pyMode', 'pyMode', 20, -400, 400, 'GSF track pyMode'),
                Plot1D('pzMode', 'pzMode', 20, -400, 400, 'GSF track pzMode'),
                Plot1D('nhits', 'nhits', 20, 0, 40, 'GSF track # hits'),
                Plot1D('pMode', 'pMode', 20, 0, 400, 'GSF track pMode'),
                Plot1D('eta', 'eta', 20, -2.5, 2.5, 'GSF track eta'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'GSF track phi'),
                Plot1D('pt', 'pt', 20, 0, 400, 'GSF track pt'),
                Plot1D('vx', 'vx', 50, -0.1, 0.1, 'GSF track vx'),
                Plot1D('vy', 'vy', 50, -0.1, 0.1, 'GSF track vy'),
                Plot1D('vz', 'vz', 50, -25, 25, 'GSF track vz'),
                Plot1D('p', 'p', 20, 0, 400, 'GSF track p')
            )
        ),
        hltGsfTrackUnseeded = cms.PSet(
            sels = cms.PSet(),
            plots = cms.VPSet(
                Plot1D('lambdaModeError', 'lambdaModeError', 20, 0, 0.1, 'GSF unseeded track lambdaModeError'),
                Plot1D('qoverpModeError', 'qoverpModeError', 20, 0, 0.05, 'GSF unseeded track qoverpModeError'),
                Plot1D('thetaModeError', 'thetaModeError', 20, 0, 0.1, 'GSF unseeded track thetaModeError'),
                Plot1D('etaModeError', 'etaModeError', 20, 0, 0.1, 'GSF unseeded track etaModeError'),
                Plot1D('phiModeError', 'phiModeError', 20, 0, 0.1, 'GSF unseeded track phiModeError'),
                Plot1D('ptModeError', 'ptModeError', 20, 0, 50, 'GSF unseeded track ptModeError'),
                Plot1D('lambdaMode', 'lambdaMode', 20, -1.5708, 1.5708, 'GSF unseeded track lambdaMode'),
                Plot1D('qoverpMode', 'qoverpMode', 20, -0.5, 0.5, 'GSF unseeded track qoverpMode'),
                Plot1D('thetaMode', 'thetaMode', 20, 0, 3.14159, 'GSF unseeded track thetaMode'),
                Plot1D('etaMode', 'etaMode', 20, -2.5, 2.5, 'GSF unseeded track etaMode'),
                Plot1D('phiMode', 'phiMode', 20, -3.14159, 3.14159, 'GSF unseeded track phiMode'),
                Plot1D('ptMode', 'ptMode', 20, 0, 400, 'GSF unseeded track ptMode'),
                Plot1D('pxMode', 'pxMode', 20, -400, 400, 'GSF unseeded track pxMode'),
                Plot1D('pyMode', 'pyMode', 20, -400, 400, 'GSF unseeded track pyMode'),
                Plot1D('pzMode', 'pzMode', 20, -400, 400, 'GSF unseeded track pzMode'),
                Plot1D('pMode', 'pMode', 20, 0, 400, 'GSF unseeded track pMode'),
                Plot1D('eta', 'eta', 20, -2.5, 2.5, 'GSF unseeded track eta'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'GSF unseeded track phi'),
                Plot1D('pt', 'pt', 20, 0, 400, 'GSF unseeded track pt'),
                Plot1D('vx', 'vx', 50, -0.1, 0.1, 'GSF unseeded track vx'),
                Plot1D('vy', 'vy', 50, -0.1, 0.1, 'GSF unseeded track vy'),
                Plot1D('vz', 'vz', 50, -25, 25, 'GSF unseeded track vz'),
                Plot1D('p', 'p', 20, 0, 400, 'GSF unseeded track p'),
                Plot1D('chargeMode', 'chargeMode', 5, -2, 3, 'GSF unseeded track chargeMode'),
                Plot1D('nhits', 'nhits', 20, 0, 40, 'GSF unseeded track # hits'),
                Plot1D('charge', 'charge', 5, -2, 3, 'GSF unseeded track charge')
            )
        ),
        hltMuon = cms.PSet(
            sels = cms.PSet(),
