...
if [ -e 'Phase2_L1P2GT_HLT_OnCPU.py' ]; then
    ...
    patatrack-scripts/benchmark -j 8 -t 8 -s 8 -e 1000 --no-run-io-benchmark --event-skip 100 --event-resolution 10 -k Phase2Timing_resources.json -- Phase2_L1P2GT_HLT_OnCPU.py
    check_logs_for_errors || exit 1
...
if [ -e 'NGTScouting_L1P2GT_HLT.py' ]; then
    ...
    patatrack-scripts/benchmark -j 8 -t 8 -s 8 -e 1000 --no-run-io-benchmark --event-skip 100 --event-resolution 10 -k Phase2Timing_resources.json -- NGTScouting_L1P2GT_HLT.py
