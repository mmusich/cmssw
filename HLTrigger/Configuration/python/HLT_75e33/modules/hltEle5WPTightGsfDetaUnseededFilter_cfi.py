...
hltEle5WPTightGsfDetaUnseededFilter = _HLTEgammaGenericQuadraticEtaFilter(
    absEtaLowEdges = [0.0, 0.8, 1.479, 2.1],
    candTag = ("hltEle5WPTightGsfOneOEMinusOneOPUnseededFilter"),
    ...
    thrRegularEE2 = [0.004],
    useEt = False,
    varTag = ("hltEgammaGsfTrackVarsUnseeded","DetaSeed")
)
