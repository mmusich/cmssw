...
hltTiclTrackstersCLUE3DHigh = _TrackstersProducer(
    ...
    original_mask = ("hltHgcalMergeLayerClusters","InitialLayerClustersMask"),
...
ticl_v5.toModify(hltTiclTrackstersCLUE3DHigh.pluginPatternRecognitionByCLUE3D, computeLocalTime = True)
