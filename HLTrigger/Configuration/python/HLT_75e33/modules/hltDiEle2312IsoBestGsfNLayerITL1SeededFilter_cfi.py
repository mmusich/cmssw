...
hltDiEle2312IsoBestGsfNLayerITL1SeededFilter = _HLTEgammaGenericFilter(
    absEtaLowEdges = [0.0, 1.479],
    candTag = ("hltDiEle2312IsoGsfDphiL1SeededFilter"),
    ...
    thrRegularEE = [3],
    useEt = False,
    varTag = ("hltEgammaBestGsfTrackVarsL1Seeded","NLayerIT")
)
