...
hltL3crIsoL1TkSingleMu22L3f24QL3trkIsoRegionalNewFiltered0p07EcalHcalHgcalTrk = _HLTMuonIsoFilter(
    ...
    MinN = 1,
    PreviousCandTag = ("hltL3crIsoL1TkSingleMu22L3f24QL3pfhgcalIsoFiltered4p70"),
    saveTags = True
)
