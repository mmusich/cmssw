...
hltEle32WPTightGsfOneOEMinusOneOPUnseededFilter = _HLTEgammaGenericQuadraticEtaFilter(
    absEtaLowEdges = [0.0, 0.8, 1.479, 2.1],
    candTag = ("hltEle32WPTightPMS2UnseededFilter"),
    ...
    thrRegularEE2 = [0.04],
    useEt = False,
    varTag = ("hltEgammaGsfTrackVarsUnseeded","OneOESuperMinusOneOP")
)
