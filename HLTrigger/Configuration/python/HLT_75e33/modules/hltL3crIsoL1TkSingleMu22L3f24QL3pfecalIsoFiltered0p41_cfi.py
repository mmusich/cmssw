...
hltL3crIsoL1TkSingleMu22L3f24QL3pfecalIsoFiltered0p41 = _HLTMuonGenericFilter(
    absEtaLowEdges = [0.0, 1.479],
    candTag = ("hltL3fL1TkSingleMu22L3Filtered24Q"),
    ...
    thrRegularEE = [-1.0],
    useEt = True,
    varTag = ("hltPhase2L3MuonsEcalIsodR0p3dRVeto0p000")
)
