...
hltParticleFlowSuperClusterECAL = _PFECALSuperClusterProducer(
    ...
    PFClusters = ("hltParticleFlowClusterECAL"),
    ...
    endcapRecHits = ("hltEalRecHit","EcalRecHitsEE"),
