...
hltTiclTrackstersRecoveryL1Seeded = _TrackstersProducer(
    detector = cms.string('HGCAL'),
    filtered_mask = ("hltFilteredLayerClustersRecoveryL1Seeded","Recovery"),
    ...
    original_mask = ("hltTiclTrackstersCLUE3DHighL1Seeded"),
