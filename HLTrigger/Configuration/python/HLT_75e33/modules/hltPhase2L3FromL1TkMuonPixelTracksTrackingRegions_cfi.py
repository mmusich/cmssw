...
(phase2L2AndL3Muons & phase2L3MuonsOIFirst).toModify(hltPhase2L3FromL1TkMuonPixelTracksTrackingRegions.RegionPSet, input = cms.InputTag("hltPhase2L3MuonFilter", "L1TkMuToReuse"))