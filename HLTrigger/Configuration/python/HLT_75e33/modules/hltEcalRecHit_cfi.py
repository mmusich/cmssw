...
hltEcalRecHit = _EcalRecHitProducer(
    ...
    EBuncalibRecHitCollection = ("hltEcalMultiFitUncalibRecHit","EcalUncalibRecHitsEB"),
    EELaserMAX = 8.0,
    EELaserMIN = 0.5,
    EErechitCollection = cms.string('EcalRecHitsEE'),
    EEuncalibRecHitCollection = ("hltEcalMultiFitUncalibRecHit","EcalUncalibRecHitsEE"),
