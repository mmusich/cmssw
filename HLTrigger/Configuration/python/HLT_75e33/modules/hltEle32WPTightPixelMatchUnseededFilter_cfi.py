...
hltEle32WPTightPixelMatchUnseededFilter = _HLTElectronPixelMatchFilter(
    candTag = ("hltEle32WPTightHcalIsoUnseededFilter"),
    l1EGCand = ("hltEgammaCandidatesUnseeded"),
    l1PixelSeedsTag = ("hltEgammaElectronPixelSeedsUnseeded"),
    ncandcut = 1,
    npixelmatchcut = 1.0,
    pixelVeto = False,
    s2_threshold = 0.4,
