...
namespace hltp2gt {
  ...
  inline l1t::P2GTCandidate::ObjectType parseObjectType(const std::string& name) {
    ...
    if (it == kTable.end())
      throw cms::Exception("Configuration")
          << "HLTP2GTFilter: unknown P2GT object type \"" << name << "\"";
    return it->second;
  }
  ...
  inline trigger::TriggerObjectType triggerTypeForP2GT(l1t::P2GTCandidate::ObjectType ot) {
    using OT = l1t::P2GTCandidate::ObjectType;
    switch (ot) {
      case OT::GCTNonIsoEg:         return trigger::TriggerL1NoIsoEG;
      case OT::GCTIsoEg:            return trigger::TriggerL1IsoEG;
      case OT::GCTJets:             return trigger::TriggerL1Jet;
      case OT::GCTTaus:             return trigger::TriggerL1TauJet;
      case OT::GCTHtSum:            return trigger::TriggerL1HTT;
      case OT::GCTEtSum:            return trigger::TriggerL1ETT;
      case OT::GMTSaPromptMuons:    return trigger::TriggerL1Mu;
      case OT::GMTSaDisplacedMuons: return trigger::TriggerL1Mu;
      case OT::GMTTkMuons:          return trigger::TriggerL1Mu;
      case OT::GMTTopo:             return trigger::TriggerL1Mu;
      case OT::GTTPromptJets:       return trigger::TriggerL1Jet;
      case OT::GTTDisplacedJets:    return trigger::TriggerL1Jet;
      case OT::GTTPhiCandidates:    return trigger::TriggerL1Jet;
      case OT::GTTRhoCandidates:    return trigger::TriggerL1Jet;
      case OT::GTTBsCandidates:     return trigger::TriggerL1Jet;
      case OT::GTTHadronicTaus:     return trigger::TriggerL1TauJet;
      case OT::GTTPromptTracks:     return trigger::TriggerTrack;
      case OT::GTTDisplacedTracks:  return trigger::TriggerTrack;
      case OT::GTTPrimaryVert:      return trigger::TriggerL1Vertex;
      case OT::GTTPromptHtSum:      return trigger::TriggerL1HTT;
      case OT::GTTDisplacedHtSum:   return trigger::TriggerL1HTT;
      case OT::GTTEtSum:            return trigger::TriggerL1ETT;
      case OT::CL2JetsSC4:          return trigger::TriggerL1Jet;
      case OT::CL2JetsSC8:          return trigger::TriggerL1Jet;
      case OT::CL2Taus:             return trigger::TriggerL1Tau;
      case OT::CL2Electrons:        return trigger::TriggerL1EG;
      case OT::CL2Photons:          return trigger::TriggerL1EG;
      case OT::CL2HtSum:            return trigger::TriggerL1HTT;
      case OT::CL2EtSum:            return trigger::TriggerL1ETT;
      default:                      return trigger::TriggerCluster;
    }
  }
  ...
  inline const char* objectTypeName(l1t::P2GTCandidate::ObjectType ot) {
    using OT = l1t::P2GTCandidate::ObjectType;
    switch (ot) {
      case OT::GCTNonIsoEg:         return "GCTNonIsoEg";
      case OT::GCTIsoEg:            return "GCTIsoEg";
      case OT::GCTJets:             return "GCTJets";
      case OT::GCTTaus:             return "GCTTaus";
      case OT::GCTHtSum:            return "GCTHtSum";
      case OT::GCTEtSum:            return "GCTEtSum";
      case OT::GMTSaPromptMuons:    return "GMTSaPromptMuons";
      case OT::GMTSaDisplacedMuons: return "GMTSaDisplacedMuons";
      case OT::GMTTkMuons:          return "GMTTkMuons";
      case OT::GMTTopo:             return "GMTTopo";
      case OT::GTTPromptJets:       return "GTTPromptJets";
      case OT::GTTDisplacedJets:    return "GTTDisplacedJets";
      case OT::GTTPhiCandidates:    return "GTTPhiCandidates";
      case OT::GTTRhoCandidates:    return "GTTRhoCandidates";
      case OT::GTTBsCandidates:     return "GTTBsCandidates";
      case OT::GTTHadronicTaus:     return "GTTHadronicTaus";
      case OT::GTTPromptTracks:     return "GTTPromptTracks";
      case OT::GTTDisplacedTracks:  return "GTTDisplacedTracks";
      case OT::GTTPrimaryVert:      return "GTTPrimaryVert";
      case OT::GTTPromptHtSum:      return "GTTPromptHtSum";
      case OT::GTTDisplacedHtSum:   return "GTTDisplacedHtSum";
      case OT::GTTEtSum:            return "GTTEtSum";
      case OT::CL2JetsSC4:          return "CL2JetsSC4";
      case OT::CL2JetsSC8:          return "CL2JetsSC8";
      case OT::CL2Taus:             return "CL2Taus";
      case OT::CL2Electrons:        return "CL2Electrons";
      case OT::CL2Photons:          return "CL2Photons";
      case OT::CL2HtSum:            return "CL2HtSum";
      case OT::CL2EtSum:            return "CL2EtSum";
  ...
  struct CollectionSpec {
    ...
    bool accepts(const l1t::P2GTCandidate& c) const {
      return c.objectType() == objectType && c.pt() >= minPt &&
             std::abs(c.eta()) <= maxAbsEta;
    }

    static void fillDescription(edm::ParameterSetDescription& desc,
                                const std::string& defaultType = "CL2Taus") {
  ...
  struct PairCuts {
    ...
    bool accepts(const l1t::P2GTCandidate& a, const l1t::P2GTCandidate& b) const {
      ...
      if (dr2 < minDR2 || dr2 > maxDR2) return false;
      if (minDEta >= 0 && std::abs(deta) < minDEta) return false;
      if (minDPhi >= 0 && std::abs(dphi) < minDPhi) return false;
      // Invariant mass (massless approximation: m² ≈ 2·pT·pT·(cosh(Δη)−cos(Δφ)))
      const double m2 = 2.0 * a.pt() * b.pt() * (std::cosh(deta) - std::cos(dphi));
      if (m2 < minInvMass2 || m2 > maxInvMass2) return false;
      return true;
    }
