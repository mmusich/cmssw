...
namespace dqm::impl {
  ...
  public:
    ...
    virtual THnSparseS *getTHnSparseS();
...
namespace dqm::legacy {
  ...
  public:
    ...
    using dqm::reco::MonitorElement::getTHnSparseS;
    virtual THnSparseS *getTHnSparseS() const {
      return const_cast<dqm::legacy::MonitorElement *>(this)->dqm::reco::MonitorElement::getTHnSparseS();
    };
