...
static constexpr auto s_tag = "[TrackerTopologyCollector]";

TEST_CASE("Standard checks of TrackerTopologyCollector", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TrackerTopologyCollector"
