...
namespace pf2pat {
  ...
  public:
    ...
    static void fillPSetDescription(edm::ParameterSetDescription& desc) {
      ...
      desc.add<bool>("doDeltaBetaCorrection");
      desc.add<edm::InputTag>("deltaBetaIsolationValueMap");
      desc.add<double>("deltaBetaFactor");
      desc.add<bool>("isRelative");
      desc.add<double>("isolationCut");
    }
