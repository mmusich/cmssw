...
#Pixel Digitizer Algorithm common part
_commonPixelDigitizerAlgorithm = cms.PSet(
...
#Pixel Digitizer Algorithm
    PixelDigitizerAlgorithm = _commonPixelDigitizerAlgorithm.clone(
...
#Pixel-3D Digitizer Algorithm
    Pixel3DDigitizerAlgorithm = _commonPixelDigitizerAlgorithm.clone(
