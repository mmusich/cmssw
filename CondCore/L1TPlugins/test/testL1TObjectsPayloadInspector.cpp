...
#include "CondCore/L1TPlugins/plugins/L1TGlobalPrescalesVetos_PayloadInspector.cc"
...
int main(int argc, char** argv) {
  ...
  L1TUtmTriggerMenu_Compare test2;
  ...
  L1TUtmTriggerMenu_CompareTwoTags test3;
  ...
  L1TGlobalPrescalesVetosTest test4;
  test4.process(connectionString, PI::mk_input(tag, start, end));
