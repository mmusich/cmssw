...
getPayloadData.py \
    ...
    --plot plot_L1TUtmTriggerMenuPlot \
...
getPayloadData.py \
    --plugin pluginL1TUtmTriggerMenu_PayloadInspector \
    --plot plot_L1TUtmTriggerMenu_Compare \
...
getPayloadData.py \
    --plugin pluginL1TUtmTriggerMenu_PayloadInspector \
    --plot plot_L1TUtmTriggerMenu_CompareTwoTags \
...
####################
# Test  L1TGlobalPrescalesVetos
####################
getPayloadData.py \
    --plugin pluginL1TGlobalPrescalesVetos_PayloadInspector \
    --plot plot_L1TGlobalPrescalesVetosTest \
