...
#
#  Usage:
#  getGTDiffByIOV.py -R <REFERENCE_GT> -T <TARGET_GT> --run <XXXXXX> [optional --verbose --match <STRING_TO_MATCH>]
#

"""
Script to checs for differences at a given run number (or at the last IOV) between two Global Tags
"""
