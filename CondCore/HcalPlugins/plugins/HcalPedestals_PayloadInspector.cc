...
namespace {
  ...
  std::string modeName(ViewMode mode) {
    switch (mode) {
  ...
  ******************************************/
  ...
  public:
    ...
    bool fill(const std::vector<std::tuple<cond::Time_t, cond::Hash>>& iovs) override {
      ...
      container->getCanvasAll(modeName(Mode))->SaveAs(m_imageFileName.c_str());
      return true;
    }  // fill method
  };
  ...
  **********************************************************/
  ...
  public:
    ...
    bool fill(const std::vector<std::tuple<cond::Time_t, cond::Hash>>& iovs) override {
      ...
      container2->getCanvasAll(modeName(Mode))->SaveAs(m_imageFileName.c_str());
      return true;
    }  // fill method
  };
