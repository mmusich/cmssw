...
>>>>>>> 7fa336eef58 (introduce SiStripCondObjectRepresent abstractions)
  ...
  public:
    SiStripApvGainCompareByPartition() : cond::payloadInspector::PlotImage<SiStripApvGain>("SiStrip Compare ApvGains By Partition"){
      setSingleIov( false );
    }
