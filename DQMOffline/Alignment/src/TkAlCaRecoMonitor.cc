...
//*************************************************************
{
  ...
  desc.add<unsigned int>("MinJetDeltaBin", 100);
  desc.add<double>("MinJetDeltaMin", 0);
  desc.add<double>("MinJetDeltaMax", 10);
  desc.add<unsigned int>("MinTrackDeltaBin", 100);
  desc.add<double>("MinTrackDeltaMin", 0);
  desc.add<double>("MinTrackDeltaMax", 3.2);
  ...
  desc.add<double>("HitMapsZMax", 300.)->setComment("cm");
  desc.add<unsigned int>("HitMapsRBin", 120);
  desc.add<double>("HitMapsRMax", 120.)->setComment("cm");
