// -*- C++ -*-
//
// Package:    TkCalibTracksMonitor
// Class:      TkCalibTracksMonitor
//
/**\class TkCalibTracksMonitor TkCalibTracksMonitor.cc
   DQMOffline/CalibTracker/src/TkCalibTracksMonitor.cc
   Monitoring special quantities related to Tracker Calibration AlCaReco Production.
*/
...
class TkCalibTracksMonitor : public DQMEDAnalyzer {
public:
  explicit TkCalibTracksMonitor(const edm::ParameterSet &);
  ~TkCalibTracksMonitor() override = default;
...
TkCalibTracksMonitor::TkCalibTracksMonitor(const edm::ParameterSet &iConfig)
...
void TkCalibTracksMonitor::bookHistograms(DQMStore::IBooker &iBooker, edm::Run const &, edm::EventSetup const &) {
...
// -- Analyse
//
void TkCalibTracksMonitor::analyze(const edm::Event &iEvent, const edm::EventSetup &iSetup) {
...
void TkCalibTracksMonitor::fillHitmaps(const reco::Track &track, const TrackerGeometry &geometry) {
...
void TkCalibTracksMonitor::fillRawIdMap(const TrackerGeometry &geometry) {
...
DEFINE_FWK_MODULE(TkCalibTracksMonitor);
