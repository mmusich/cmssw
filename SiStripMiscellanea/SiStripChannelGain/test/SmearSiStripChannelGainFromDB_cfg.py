...
import SiStripMiscellanea.SiStripChannelGain.smearSiStripGainsConfig_cfi as Thresholds

process.demo = cms.EDAnalyzer('SmearSiStripChannelGainFromDB',
...
##
process.CondDB.connect = 'sqlite_file:modifiedGains_'+options.globalTag+'_IOV_'+str(options.runNumber)+"partitionThresholds.db"
