...
hltMtdTracksValid = _mtdTracksValid.clone(
    ...
    trackMVAQual = cms.InputTag('hltMTrackQualityMVA', 'mtdQualMVA'),
...
hltVertices4DValid =  _vertices4DValid.clone(
    ...
    t0SafePID = cms.InputTag('hltTofPID', 't0safe'),
    sigmat0SafePID = cms.InputTag('hltTofPID', 'sigmat0safe'),
    trackMVAQual = cms.InputTag('hltTtdTrackQualityMVA', 'mtdQualMVA'),
...
mtdRecoValid = cms.Sequence(hltMtdAssociationProducers + hltMtdTracksValid + hltVertices4DValid)
