...
void PFCandidateAnalyzerHLTDQM::bookHistograms(DQMStore::IBooker& booker, edm::Run const&, edm::EventSetup const&) {
  ...
  me["AllCandidateECALEnergyHigh"] =
      booker.book1D("AllCandidateECALEnergyHigh", "AllCandidateECALEnergy", 100, 100., 1000.);
  ...
  me["AllCandidateHCALEnergyHigh"] =
      booker.book1D("AllCandidateHCALEnergyHigh", "AllCandidateHCALEnergy", 100, 100., 1000.);
  me["AllCandidateHCALEnergy"] = booker.book1D("AllCandidateHCALEnergy", "AllCandidateHCALEnergy", 100, 0., 1000.);
  me["AllCandidateECALEnergyCorrLow"] =
      booker.book1D("AllCandidateECALEnergyCorrLow", "AllCandidateECALEnergyCorr", 100, 0., 5.);
  me["AllCandidateECALEnergyCorrMid"] =
      booker.book1D("AllCandidateECALEnergyCorrMid", "AllCandidateECALEnergyCorr", 100, 5., 100.);
  me["AllCandidateECALEnergyCorrHigh"] =
      booker.book1D("AllCandidateECALEnergyCorrHigh", "AllCandidateECALEnergyCorr", 100, 100., 1000.);
  me["AllCandidateHCALEnergyCorrLow"] =
      booker.book1D("AllCandidateHCALEnergyCorrLow", "AllCandidateHCALEnergyCorr", 100, 0., 5.);
  me["AllCandidateHCALEnergyCorrMid"] =
      booker.book1D("AllCandidateHCALEnergyCorrMid", "AllCandidateHCALEnergyCorr", 100, 5., 100.);
  me["AllCandidateHCALEnergyCorrHigh"] =
      booker.book1D("AllCandidateHCALEnergyCorrHigh", "AllCandidateHCALEnergyCorr", 100, 100., 1000.);
  me["AllCandidateHCALEnergyCorr"] =
      booker.book1D("AllCandidateHCALEnergyCorr", "AllCandidateHCALEnergyCorr", 100, 0., 1000.);
  ...
  me["AllCandidateHFECALEnergyLow"] =
      booker.book1D("AllCandidateHFECALEnergyLow", "AllCandidateHFECALEnergy", 100, 0., 5.);
  me["AllCandidateHFECALEnergyMid"] =
      booker.book1D("AllCandidateHFECALEnergyMid", "AllCandidateHFECALEnergy", 100, 5., 100.);
  me["AllCandidateHFECALEnergyHigh"] =
      booker.book1D("AllCandidateHFECALEnergyHigh", "AllCandidateHFECALEnergy", 100, 100., 1000.);
  me["AllCandidateHFHCALEnergyLow"] =
      booker.book1D("AllCandidateHFHCALEnergyLow", "AllCandidateHFHCALEnergy", 100, 0., 5.);
  me["AllCandidateHFHCALEnergyMid"] =
      booker.book1D("AllCandidateHFHCALEnergyMid", "AllCandidateHFHCALEnergy", 100, 5., 100.);
  me["AllCandidateHFHCALEnergyHigh"] =
      booker.book1D("AllCandidateHFHCALEnergyHigh", "AllCandidateHFHCALEnergy", 100, 100., 1000.);
  me["AllCandidateHFHCALEnergy"] =
      booker.book1D("AllCandidateHFHCALEnergy", "AllCandidateHFHCALEnergy", 100, 0., 1000.);
  me["AllCandidateHFHOEnergy"] = booker.book1D("AllCandidateHFHOEnergy", "AllCandidateHFHOEnergy", 50, 0., 0.1);
  me["AllCandidateHFECALEnergyCorrLow"] =
      booker.book1D("AllCandidateHFECALEnergyCorrLow", "AllCandidateHFECALEnergyCorr", 100, 0., 5.);
  me["AllCandidateHFECALEnergyCorrMid"] =
      booker.book1D("AllCandidateHFECALEnergyCorrMid", "AllCandidateHFECALEnergyCorr", 100, 5., 100.);
  me["AllCandidateHFECALEnergyCorrHigh"] =
      booker.book1D("AllCandidateHFECALEnergyCorrHigh", "AllCandidateHFECALEnergyCorr", 100, 100., 1000.);
  me["AllCandidateHFHCALEnergyCorrLow"] =
      booker.book1D("AllCandidateHFHCALEnergyCorrLow", "AllCandidateHFHCALEnergyCorr", 100, 0., 5.);
  me["AllCandidateHFHCALEnergyCorrMid"] =
      booker.book1D("AllCandidateHFHCALEnergyCorrMid", "AllCandidateHFHCALEnergyCorr", 100, 5., 100.);
  me["AllCandidateHFHCALEnergyCorrHigh"] =
      booker.book1D("AllCandidateHFHCALEnergyCorrHigh", "AllCandidateHFHCALEnergyCorr", 100, 100., 1000.);
  me["AllCandidateHFHCALEnergyCorr"] =
      booker.book1D("AllCandidateHFHCALEnergyCorr", "AllCandidateHFHCALEnergyCorr", 100, 0., 1000.);
  me["AllCandidateHFHOEnergyCorr"] =
      booker.book1D("AllCandidateHFHOEnergyCorr", "AllCandidateHFHOEnergyCorr", 50, 0., 0.1);
  ...
  me["UndefinedECALEnergyCorrLow"] =
      booker.book1D("UndefinedECALEnergyCorrLow", "UndefinedECALEnergyCorr", 100, 0., 5.);
  me["UndefinedECALEnergyCorrMid"] =
      booker.book1D("UndefinedECALEnergyCorrMid", "UndefinedECALEnergyCorr", 100, 5., 100.);
  me["UndefinedECALEnergyCorrHigh"] =
      booker.book1D("UndefinedECALEnergyCorrHigh", "UndefinedECALEnergyCorr", 100, 100., 1000.);
  me["UndefinedHCALEnergyCorrLow"] =
      booker.book1D("UndefinedHCALEnergyCorrLow", "UndefinedHCALEnergyCorr", 100, 0., 5.);
  me["UndefinedHCALEnergyCorrMid"] =
      booker.book1D("UndefinedHCALEnergyCorrMid", "UndefinedHCALEnergyCorr", 100, 5., 100.);
  me["UndefinedHCALEnergyCorrHigh"] =
      booker.book1D("UndefinedHCALEnergyCorrHigh", "UndefinedHCALEnergyCorr", 100, 100., 1000.);
  ...
  for (auto& pair : pdgMap) {
    ...
    if (pair.second == "muon") {
      ...
      me["Muon20GeVPhi"] = booker.book1D("Muon20GeVPhi", "Muon20GeVPhi", 30, -M_PI, +M_PI);
      ...
      me["Muon20GeVECALEnergyHigh"] =
          booker.book1D("Muon20GeVECALEnergyHigh", "Muon20GeVECALEnergyHigh", 30, 100., 1000.);
      ...
      me["Muon20GeVHCALEnergyHigh"] =
          booker.book1D("Muon20GeVHCALEnergyHigh", "Muon20GeVHCALEnergyHigh", 30, 100., 1000.);
      me["Muon20GeVHOEnergy"] = booker.book1D("Muon20GeVHOEnergy", "Muon20GeVHOEnergy", 50, 0., 0.1);
      me["Muon20GeVECALEnergyCorrLow"] =
          booker.book1D("Muon20GeVECALEnergyCorrLow", "Muon20GeVECALEnergyCorrLow", 100, 0., 5.);
      me["Muon20GeVECALEnergyCorrMid"] =
          booker.book1D("Muon20GeVECALEnergyCorrMid", "Muon20GeVECALEnergyCorrMid", 50, 5., 100.);
      me["Muon20GeVECALEnergyCorrHigh"] =
          booker.book1D("Muon20GeVECALEnergyCorrHigh", "Muon20GeVECALEnergyCorrHigh", 30, 100., 1000.);
      me["Muon20GeVHCALEnergyCorrLow"] =
          booker.book1D("Muon20GeVHCALEnergyCorrLow", "Muon20GeVHCALEnergyCorrLow", 100, 0., 5.);
      me["Muon20GeVHCALEnergyCorrMid"] =
          booker.book1D("Muon20GeVHCALEnergyCorrMid", "Muon20GeVHCALEnergyCorrMid", 50, 5., 100.);
      me["Muon20GeVHCALEnergyCorrHigh"] =
          booker.book1D("Muon20GeVHCALEnergyCorrHigh", "Muon20GeVHCALEnergyCorrHigh", 30, 100., 1000.);
      ...
      me["muonPhi"] = booker.book1D("muonPhi", "muonPhi", 30, -M_PI, +M_PI);
      ...
      me[pair.second + "Linear10Pt"] =
          booker.book1D(pair.second + "Linear10Pt", pair.second + "Linear10Pt", 120, 0.05, 50);
      me[pair.second + "Log10Pt"] = booker.book1D(pair.second + "Log10Pt", pair.second + "Log10Pt", 120, -2, 4);
      if (pair.second == "photon") {
        me[pair.second + "Phi"] = booker.book1D(pair.second + "Phi", pair.second + "Phi", 50, -M_PI, +M_PI);
      } else {
      ...
      me[pair.second + "ECALEnergyMid"] =
          booker.book1D(pair.second + "ECALEnergyMid", pair.second + "ECALEnergyMid", 50, 5., 100.);
      me[pair.second + "ECALEnergyHigh"] =
          booker.book1D(pair.second + "ECALEnergyHigh", pair.second + "ECALEnergyHigh", 30, 100., 1000.);
      ...
      me[pair.second + "HCALEnergyMid"] =
          booker.book1D(pair.second + "HCALEnergyMid", pair.second + "HCALEnergyMid", 50, 5., 100.);
      me[pair.second + "HCALEnergyHigh"] =
          booker.book1D(pair.second + "HCALEnergyHigh", pair.second + "HCALEnergyHigh", 30, 100., 1000.);
      me[pair.second + "HOEnergy"] = booker.book1D(pair.second + "HOEnergy", pair.second + "HOEnergy", 50, 0., 0.1);
      me[pair.second + "ECALEnergyCorrLow"] =
          booker.book1D(pair.second + "ECALEnergyCorrLow", pair.second + "ECALEnergyCorrLow", 100, 0., 5.);
      me[pair.second + "ECALEnergyCorrMid"] =
          booker.book1D(pair.second + "ECALEnergyCorrMid", pair.second + "ECALEnergyCorrMid", 50, 5., 100.);
      me[pair.second + "ECALEnergyCorrHigh"] =
          booker.book1D(pair.second + "ECALEnergyCorrHigh", pair.second + "ECALEnergyCorrHigh", 30, 100., 1000.);
      me[pair.second + "HCALEnergyCorrLow"] =
          booker.book1D(pair.second + "HCALEnergyCorrLow", pair.second + "HCALEnergyCorrLow", 100, 0., 5.);
      me[pair.second + "HCALEnergyCorrMid"] =
          booker.book1D(pair.second + "HCALEnergyCorrMid", pair.second + "HCALEnergyCorrMid", 50, 5., 100.);
      me[pair.second + "HCALEnergyCorrHigh"] =
          booker.book1D(pair.second + "HCALEnergyCorrHigh", pair.second + "HCALEnergyCorrHigh", 30, 100., 1000.);
      me[pair.second + "HOEnergyCorr"] =
          booker.book1D(pair.second + "HOEnergyCorr", pair.second + "HOEnergyCorr", 50, 0., 0.1);
