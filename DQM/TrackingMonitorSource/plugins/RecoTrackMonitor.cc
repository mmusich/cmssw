...
void RecoTrackMonitor::bookHistograms(DQMStore::IBooker& iBook, edm::Run const& iRun, edm::EventSetup const& iSetup) {
  ...
  // RecHits
  hitmap_pixelH_ = iBook.book2D(
      "hitmap_pixel", "2D hitefficiency map in Global eta-phi plane of Pixel", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_pixelH_ = iBook.book2D(
      "hitmap2_pixel", "2D hitefficiency map in Global z-phi plane of Pixel", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_stripH_ = iBook.book2D(
      "hitmap_strip", "2D hitefficiency map in Global eta-phi plane of Strip", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_stripH_ = iBook.book2D(
      "hitmap2_strip", "2D hitefficiency map in Global z-phi plane of STrip", 120, -20.0, 20.0, 200, -3.2, 3.2);

  // Pixel Barrel
  hitmap_PixB_LayerH_[0] =
      iBook.book2D("hitmap_PixB_L1", "2D hitefficiency map in Global eta-phi PixBL1", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_PixB_LayerH_[0] = iBook.book2D(
      "hitmap2_PixB_L1", "2D hitefficiency map in Global z-phi plane of PixBL1", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_PixB_LayerH_[1] =
      iBook.book2D("hitmap_PixB_L2", "2D hitefficiency map in Global eta-phi PixBL2", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_PixB_LayerH_[1] = iBook.book2D(
      "hitmap2_PixB_L2", "2D hitefficiency map in Global z-phi plane of PixBL2", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_PixB_LayerH_[2] =
      iBook.book2D("hitmap_PixB_L3", "2D hitefficiency map in Global eta-phi PixBL3", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_PixB_LayerH_[2] = iBook.book2D(
      "hitmap2_PixB_L3", "2D hitefficiency map in Global z-phi plane of PixBL3", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_PixB_LayerH_[3] =
      iBook.book2D("hitmap_PixB_L4", "2D hitefficiency map in Global eta-phi PixBL4", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_PixB_LayerH_[3] = iBook.book2D(
      "hitmap2_PixB_L4", "2D hitefficiency map in Global z-phi plane of PixBL4", 120, -20.0, 20.0, 200, -3.2, 3.2);

  // TIB
  hitmap_TIB_LayerH_[0] =
      iBook.book2D("hitmap_TIB_L1", "2D hitefficiency map in Global eta-phi TIBL1", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TIB_LayerH_[0] = iBook.book2D(
      "hitmap2_TIB_L1", "2D hitefficiency map in Global z-phi plane of TIBL1", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TIB_LayerH_[1] =
      iBook.book2D("hitmap_TIB_L2", "2D hitefficiency map in Global eta-phi TIBL2", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TIB_LayerH_[1] = iBook.book2D(
      "hitmap2_TIB_L2", "2D hitefficiency map in Global z-phi plane of TIBL2", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TIB_LayerH_[2] =
      iBook.book2D("hitmap_TIB_L3", "2D hitefficiency map in Global eta-phi TIBL3", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TIB_LayerH_[2] = iBook.book2D(
      "hitmap2_TIB_L3", "2D hitefficiency map in Global z-phi plane of TIBL3", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TIB_LayerH_[3] =
      iBook.book2D("hitmap_TIB_L4", "2D hitefficiency map in Global eta-phi TIBL4", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TIB_LayerH_[3] = iBook.book2D(
      "hitmap2_TIB_L4", "2D hitefficiency map in Global z-phi plane of TIBL4", 120, -20.0, 20.0, 200, -3.2, 3.2);

  // TOB
  hitmap_TOB_LayerH_[0] =
      iBook.book2D("hitmap_TOB_L1", "2D hitefficiency map in Global eta-phi TOBL1", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TOB_LayerH_[0] = iBook.book2D(
      "hitmap2_TOB_L1", "2D hitefficiency map in Global z-phi plane of TOBL1", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TOB_LayerH_[1] =
      iBook.book2D("hitmap_TOB_L2", "2D hitefficiency map in Global eta-phi TOBL2", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TOB_LayerH_[1] = iBook.book2D(
      "hitmap2_TOB_L2", "2D hitefficiency map in Global z-phi plane of TOBL2", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TOB_LayerH_[2] =
      iBook.book2D("hitmap_TOB_L3", "2D hitefficiency map in Global eta-phi TOBL3", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TOB_LayerH_[2] = iBook.book2D(
      "hitmap2_TOB_L3", "2D hitefficiency map in Global z-phi plane of TOBL3", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TOB_LayerH_[3] =
      iBook.book2D("hitmap_TOB_L4", "2D hitefficiency map in Global eta-phi TOBL4", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TOB_LayerH_[3] = iBook.book2D(
      "hitmap2_TOB_L4", "2D hitefficiency map in Global z-phi plane of TOBL4", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TOB_LayerH_[4] =
      iBook.book2D("hitmap_TOB_L5", "2D hitefficiency map in Global eta-phi TOBL5", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TOB_LayerH_[4] = iBook.book2D(
      "hitmap2_TOB_L5", "2D hitefficiency map in Global z-phi plane of TOBL5", 120, -20.0, 20.0, 200, -3.2, 3.2);

  hitmap_TOB_LayerH_[5] =
      iBook.book2D("hitmap_TOB_L6", "2D hitefficiency map in Global eta-phi TOBL6", 60, -3.0, 3.0, 70, -3.5, 3.5);
  ...
  hitmap2_TOB_LayerH_[5] = iBook.book2D(
      "hitmap2_TOB_L6", "2D hitefficiency map in Global z-phi plane of TOBL6", 120, -20.0, 20.0, 200, -3.2, 3.2);
}
void RecoTrackMonitor::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup) {
  if (verbose_)
    std::cout << "Begin RecoTrackMonitor" << std::endl;
  ...
  if (!vertexColl->->empty()) {
    ...
    if (!iEvent.isRealData()) {
      ...
      if (verbose_)
        edm::LogInfo("RecoTrackMonitor") << "nPUColl = " << PupInfo->size();
      for (auto const& v : *PupInfo) {
        ...
        if (bx == 0) {
          ...
          if (doPUCorrection_) {
            wfac = (nVertex > -1 && nVertex < static_cast<int>(vpu_.size())) ? vpu_.at(nVertex) : 0.0;
          }
        }
      }
    }
    if (verbose_) {
      edm::LogInfo("RecoTrackMonitor") << "PU reweight factor = " << wfac;
    ...
    if (tracks.isValid()) {
      ...
      for (auto const& track : *tracks) {
        ...
        const reco::TrackResiduals& residuals = track.residuals();
        int i = 0;
        for (auto it = track.recHitsBegin(); it != track.recHitsEnd(); ++it, ++i) {
          ...
          if (hitn.isValid()) {
            ...
            if (hitn.geographicalId().det() == DetId::Tracker) {
              ...
              if (false)
                std::cout << "Hit Dimension: " << hitn.dimension() << ", isGlued: " << stripId.glued()
                          << ", isStereo: " << stripId.stereo() << std::endl;
    ...
    if (clusterHandle.isValid())
      processClusters(clusterHandle, iSetup, tkGeom, wfac);
    else
      edm::LogError("RecoTrackMonitor") << "ClusterCollection " << clusterTag_ << " not valid!!" << std::endl;

    if (verbose_)
      std::cout << "Ends RecoTrackMonitor successfully" << std::endl;
  }
}
...
void RecoTrackMonitor::processHit(const TrackingRecHit& recHit,
                                  edm::EventSetup const& iSetup,
                                  const TrackerGeometry& tkGeom,
                                  double wfac) {
