...
# Sequences 
#SiStripDQMTier0_cosmicTk = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*SiStripMonitorTrack_cosmicTk*MonitorTrackResiduals_cosmicTk*TrackMon_cosmicTk*TrackEffMon_cosmicTk)
SiStripDQMTier0_cosmicTk = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*SiStripMonitorTrack_cosmicTk*MonitorTrackResiduals_cosmicTk)

#removed modules using TkDetMap
#SiStripDQMTier0_ckf = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*MonitorTrackResiduals_ckf*TrackMon_ckf*TrackEffMon_ckf)
SiStripDQMTier0_ckf = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*SiStripMonitorTrack_ckf*MonitorTrackResiduals_ckf)

#SiStripDQMTier0_rs = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*SiStripMonitorTrack_rs*MonitorTrackResiduals_rs*TrackMon_rs*TrackEffMon_rs)

#removed modules using TkDetMap
#SiStripDQMTier0 = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*siStripFEDCheck*MonitorTrackResiduals_ckf*TrackMon_cosmicTk*TrackMon_ckf*TrackEffMon_ckf*TrackSplitMonitor*dqmInfoSiStrip)
#SiStripDQMTier0 = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*siStripFEDCheck*siStripFEDMonitor*SiStripMonitorDigi*SiStripMonitorCluster*SiStripMonitorTrack_ckf*MonitorTrackResiduals_ckf*TrackMon_cosmicTk*TrackMon_ckf*TrackEffMon_ckf*TrackSplitMonitor*dqmInfoSiStrip)
SiStripDQMTier0 = cms.Sequence(APVPhases*unpackTcds*consecutiveHEs*siStripFEDCheck*siStripFEDMonitor*SiStripMonitorDigi*SiStripMonitorCluster*SiStripMonitorTrack_ckf*MonitorTrackResiduals_ckf*dqmInfoSiStrip)
