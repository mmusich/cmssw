...
static constexpr auto s_tag = "[TwoBodyDecayAnalyzer]";

TEST_CASE("Standard checks of TwoBodyDecayAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TwoBodyDecayAnalyzer"
