...
# process.load("Alignment.OfflineValidation.Dataset_TkAlMinBias_cff")
process.load("Alignment.OfflineValidation.Dataset_TkAlMinBias_cff")
...
reportEvery = cms.untracked.int32(10) # every 1000th only
...
process.conditionsInTrackerAlignmentRcd = CalibTracker.Configuration.Common.PoolDBESSource_cfi.poolDBESSource.clone(
     connect = cms.string('sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/PayLoads/TkAl-14-02_CSA14/Alignments_CSA14_v1.db'),
...
process.TrackerOfflineValidationStandalone.moduleLevelProfiles = False

process.TFileService.fileName = 'AlignmentValidation_validation_InitialGeometry.root'
