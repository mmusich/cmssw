>>>>>>>>>> testPVValidation_cfg.py: msg%-i: This is DATA!
>>>>>>>>>> testPVValidation_cfg.py: msg%-i: All is taken from GT
...
process.PVValidation = cms.EDAnalyzer("PrimaryVertexValidation",
    ...
    intLumi = cms.untracked.double(205.418),
...
process.p = cms.Path(process.goodvertexSkim+process.offlineBeamSpot+process.FinalTrackRefitter+process.PVValidation)
