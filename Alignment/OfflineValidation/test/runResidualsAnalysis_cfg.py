# Usage: 
#   cmsRun runResidualsAnalysis_cfg.py globalTag=<global_tag> inputData='<input_data>' trackCollection=<track_collection> maxEvents=<max_events>
# 
# Example:
#   cmsRun runResidualsAnalysis_cfg.py globalTag=140X_dataRun3_Express_v2 inputData='/eos/cms/store/express/Run2024B/StreamExpress/ALCARECO/TkAlMinBias-Express-v1/000/379/315/00000/*' trackCollection=ALCARECOTkAlMinBias maxEvents=10000
...
if options.isCosmics:
    print("=====> going to use the cosmics track refitter")
    ...
    print("=====> going to use standard track refitter")
...
process.dmrchecker = cms.EDAnalyzer("DMRChecker",
                                 TkTag  = cms.InputTag('TrackRefitter1'),
                                 isCosmics = cms.bool(options.isCosmics))

process.fastdmr = cms.EDAnalyzer("FastDMRChecker",
                                 minHitsPerModule = cms.int32(2),
