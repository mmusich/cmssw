...
_theTrackCollection = 'ALCARECOTkAlHLTTracks'
...
process.BeamSpotChecker = beamSpotCompatibilityChecker.clone(
    bsFromEvent = "hltOnlineBeamSpot::HLT",  # source of the event beamspot (in the ALCARECO files)
...
process.PVValidation = cms.EDAnalyzer("PrimaryVertexValidation",
                                      ...
                                      VertexCollectionTag = cms.InputTag("hltVerticesPFFilter"),
