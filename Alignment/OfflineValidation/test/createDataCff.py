...
##############################################
    ...
    parser.add_option('-s','--start',  help='starting point',        dest='start',  action='store'     ,default='1')
    ...
    parser.add_option('-n','--name',   help='name appended to cff',  dest='dataname',action='store'    ,default='MinBias')   
    ...
    if(not opts.isDate):
        ...
        for run in listOfRuns:
            ...
            if (run>=opts.start and run<opts.end):
                ...
                events_in_run = 0
                cffName = "PVValidation_"+opts.dataname+"_TkAlMinBias_"+run+"_cff.py" 
                ...
                if len(lfn)==0 :
                    ...
                    totalEvents+=events_in_run
                    print "There are ",totalEvents," events in this dataset, until now."
        ...
        print  "There are ",totalEvents," events in this dataset! Confirmed." 
