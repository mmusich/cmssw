...
#readFiles.extend([ '/store/data/Run2018C/HLTPhysics/ALCARECO/TkAlMinBias-PromptReco-v1/000/319/347/00000/82932D00-D084-E811-BD79-FA163E79AC5B.root'])
...
process.MessageLogger.categories.append("BeamSpotChecker")  
...
process.MessageLogger.cout = cms.untracked.PSet(
    ...
    BeamSpotChecker = cms.untracked.PSet( limit = cms.untracked.int32(-1)),
    )
...
# process.seqTrackselRefit.replace(process.offlineBeamSpot,process.myOfflineBeamSpot)
# #process.seqTrackselRefit.remove(process.offlineBeamSpot)
...
process.FinalTrackRefitter.beamSpot = "myOfflineBeamSpot"
...
#process.GlobalTag = GlobalTag(process.GlobalTag,"110X_dataRun2_v10")
...
if isDA:
     ...
     process.PVValidation = cms.EDAnalyzer("PrimaryVertexValidation",
                                           ...
                                           BeamSpotTag = cms.untracked.InputTag("myOfflineBeamSpot"),
                                           ...
                                           TkFilterParameters = cms.PSet(algorithm=cms.string('filter'),                           
                                                                         ...
                                                                         #maxD0Significance = cms.double(FLOAT_MAX),                 # fake cut (requiring 1 PXB hit)     
                                           ...
                                           TkClusParameters=cms.PSet(algorithm=cms.string('DA_vect'),
                                                                     TkDAClusParameters = cms.PSet(coolingFactor = cms.double(0.6),  # moderate annealing speed
                                                                                                   ...
                                                                                                   #d0CutOff = cms.double(FLOAT_MAX),        # downweight high IP tracks
                                                                                                   #dzCutOff = cms.double(FLOAT_MAX),        # outlier rejection after freeze-out (T<Tmin)
...
process.BeamSpotChecker = cms.EDAnalyzer("BeamSpotChecker",
                                         ...
                                         bsFromDB = cms.InputTag("myOfflineBeamSpot"),  # source of the DB beamspot (from Global Tag)
                                         warningThr = cms.double(0.),                   # significance threshold to send a warning message
                                         errorThr = cms.double(0.)               # significance threshold to abort the job 
                                         )

process.TFileService = cms.Service("TFileService",
    fileName = cms.string('BAD.root')
)
