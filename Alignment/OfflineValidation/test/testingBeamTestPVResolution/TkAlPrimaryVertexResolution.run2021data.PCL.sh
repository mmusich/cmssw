...
mkdir -p /afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/results/musich/PVValidationBeamTest/testingBeamTestPVResolution/PrimaryVertexResolution/run2021data/PCL
...
then
    mkdir -p /tmp/musich/testingBeamTestPVResolution/8929837194
    rm -f /tmp/musich/testingBeamTestPVResolution/8929837194/*
    cd /tmp/musich/testingBeamTestPVResolution/8929837194
else
...
cmsRun /tmp/musich/CMSSW_12_0_3_patch1/src/Alignment/OfflineValidation/test/testingBeamTestPVResolution/TkAlPrimaryVertexResolution.run2021data.PCL_cfg.py
...
do
    ...
    cp ${RootOutputFile}  /afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/results/musich/PVValidationBeamTest/testingBeamTestPVResolution/PrimaryVertexResolution/run2021data/PCL
done
...
mkdir -p /afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/results/musich/PVValidationBeamTest/testingBeamTestPVResolution/PrimaryVertexResolution/run2021data/PCL/plots
for PngOutputFile in $(ls *png ); do
    ...
    cp ${PngOutputFile}  /afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/results/musich/PVValidationBeamTest/testingBeamTestPVResolution/PrimaryVertexResolution/run2021data/PCL/plots
done
...
for PdfOutputFile in $(ls *pdf ); do
    ...
    cp ${PdfOutputFile}  /afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/results/musich/PVValidationBeamTest/testingBeamTestPVResolution/PrimaryVertexResolution/run2021data/PCL/plots
done
