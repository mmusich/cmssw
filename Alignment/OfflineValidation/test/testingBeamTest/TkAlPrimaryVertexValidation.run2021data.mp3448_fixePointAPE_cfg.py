...
process.GlobalTag.toGet = cms.VPSet(cms.PSet(record = cms.string('BeamSpotObjectsRcd'),
                                    ...
                                    cms.PSet(record = cms.string('TrackerAlignmentErrorExtendedRcd'),
                                             connect = cms.string('sqlite_file:/afs/cern.ch/user/l/lsreelat/public/APE_BPIX20_FPIX10_TIB10_TID20_TOB10_TEC20.db'),
                                             tag = cms.string('APEs')
                                             )                                    
                                    )
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('PrimaryVertexValidation_run2021data_mp3448_fixedPointAPE.root')
)
