...
process.GlobalTag.toGet = cms.VPSet(cms.PSet(record = cms.string('BeamSpotObjectsRcd'),
                                    ...
                                    cms.PSet(record = cms.string('TrackerAlignmentErrorExtendedRcd'),
                                             connect = cms.string('sqlite_file:/afs/cern.ch/user/l/lsreelat/public/TestBeam_21/APE_Test_Beam.db'),
                                             tag = cms.string('APEs')
                                             )                       
                                    )
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('PrimaryVertexValidation_run2021data_mp3448_measuredAPEs.root')
)
