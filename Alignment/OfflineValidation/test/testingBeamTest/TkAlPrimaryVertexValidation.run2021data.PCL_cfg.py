...
process.GlobalTag.toGet = cms.VPSet(cms.PSet(record = cms.string('BeamSpotObjectsRcd'),
                                    ...
                                    cms.PSet(connect = cms.string('sqlite_file:/afs/cern.ch/user/m/musich/public/testBeam2021/promptCalibConditions_highStats.db'),
...
#      connect = cms.string('sqlite_file:/afs/cern.ch/user/m/musich/public/testBeam2021/promptCalibConditions_highStats.db'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('PrimaryVertexValidation_run2021data_PCL.root')
)
