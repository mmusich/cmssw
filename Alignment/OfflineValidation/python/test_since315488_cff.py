...
goodLumiSecs = LumiList.LumiList(filename = '/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/MP/MPproduction/datasetfiles/Collisions2018/ReRecoABCD-HGIOV/HLTPhysics_Run2018A-TkAlMinBias-06Jun2018-v1_ALCARECO/HLTPhysics_Run2018A-TkAlMinBias-06Jun2018-v1_ALCARECO_since315488_JSON.txt').getCMSSWString().split(',')
