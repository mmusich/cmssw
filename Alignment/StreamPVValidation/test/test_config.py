...
process.TFileService = cms.Service("TFileService",
                                   #fileName=cms.string("PVValidation_PromptGT_321833_clusterRepair.root")
                                   #fileName=cms.string("PVValidation_PromptGT_321833_PromptReco.root")
                                   fileName=cms.string("PVValidation_PromptGT_321833_PromptReco_refitWFPix.root")
                                  )                                    
...
if isDA:
     ...
     process.PVValidation = cms.EDAnalyzer("PrimaryVertexValidation",
                                           ...
                                           intLumi = cms.untracked.double(3.279),
