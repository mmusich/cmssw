...
# with command line options: step3 --datatier ALCARECO --conditions auto:run1_data -s ALCA:SiStripCalZeroBias+TkAlMinBias+DtCalib+Hotline+LumiPixelsMinBias+PromptCalibProd+PromptCalibProdSiStrip+PromptCalibProdSiStripGains+PromptCalibProdSiStripGainsAfterAbortGap+PromptCalibProdSiPixelAli --eventcontent ALCARECO -n 100 --filein file:step2.root --fileout file:step3.root
...
process.ALCARECOStreamHotline = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
    ...
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('Hotline')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('Hotline.root'),
    outputCommands = cms.untracked.vstring( ('drop *', 
...
process.ALCARECOStreamPromptCalibProd = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOPromptCalibProd')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('PromptCalibProd')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('PromptCalibProd.root'),
    outputCommands = cms.untracked.vstring('drop *', 
...
process.ALCARECOStreamPromptCalibProdSiStripGainsAfterAbortGap = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOPromptCalibProdSiStripGainsAfterAbortGap')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('PromptCalibProdSiStripGainsAfterAbortGap')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('PromptCalibProdSiStripGainsAfterAbortGap.root'),
    outputCommands = cms.untracked.vstring('drop *', 
        'keep *_alcaBeamSpotProducer_*_*', 
...
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOPromptCalibProd_noDrop.outputCommands)
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOPromptCalibProdSiPixelAli_noDrop.outputCommands)
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOPromptCalibProdSiStripGainsAfterAbortGap_noDrop.outputCommands)
...
process.ALCARECOStreamHotlineOutPath = cms.EndPath(process.ALCARECOStreamHotline)
process.ALCARECOStreamLumiPixelsMinBiasOutPath = cms.EndPath(process.ALCARECOStreamLumiPixelsMinBias)
process.ALCARECOStreamPromptCalibProdOutPath = cms.EndPath(process.ALCARECOStreamPromptCalibProd)
...
process.ALCARECOStreamPromptCalibProdSiStripGainsAfterAbortGapOutPath = cms.EndPath(process.ALCARECOStreamPromptCalibProdSiStripGainsAfterAbortGap)
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECOPromptCalibProdSiStripGains,process.pathHotlineSkimSingleMuon,process.pathHotlineSkimDoubleMuon,process.pathHotlineSkimTripleMuon,process.pathHotlineSkimSingleElectron,process.pathHotlineSkimDoubleElectron,process.pathHotlineSkimTripleElectron,process.pathHotlineSkimSinglePhoton,process.pathHotlineSkimDoublePhoton,process.pathHotlineSkimTriplePhoton,process.pathHotlineSkimSingleJet,process.pathHotlineSkimDoubleJet,process.pathHotlineSkimMultiJet,process.pathHotlineSkimHT,process.pathHotlineSkimMassiveDimuon,process.pathHotlineSkimMassiveDielectron,process.pathHotlineSkimMassiveEMu,process.pathHotlineSkimPFMET,process.pathHotlineSkimCaloMET,process.pathHotlineSkimCondMET,process.pathALCARECOLumiPixelsMinBias,process.pathALCARECOTkAlMinBias,process.pathALCARECOPromptCalibProd,process.pathALCARECOPromptCalibProdSiPixelAli,process.pathALCARECOPromptCalibProdSiStripGainsAfterAbortGap,process.pathALCARECOPromptCalibProdSiStrip,process.pathALCARECODtCalib,process.pathALCARECOSiStripCalZeroBias,process.endjob_step,process.ALCARECOStreamDtCalibOutPath,process.ALCARECOStreamHotlineOutPath,process.ALCARECOStreamLumiPixelsMinBiasOutPath,process.ALCARECOStreamPromptCalibProdOutPath,process.ALCARECOStreamPromptCalibProdSiPixelAliOutPath,process.ALCARECOStreamPromptCalibProdSiStripOutPath,process.ALCARECOStreamPromptCalibProdSiStripGainsOutPath,process.ALCARECOStreamPromptCalibProdSiStripGainsAfterAbortGapOutPath,process.ALCARECOStreamSiStripCalZeroBiasOutPath,process.ALCARECOStreamTkAlMinBiasOutPath)
