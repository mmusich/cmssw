...
// Class:      CPEanalyzer
//
/**\class CPEanalyzer CPEanalyzer.cc SiStripCPE/CPEanalyzer/plugins/CPEanalyzer.cc
...
private:
  ...
  const edm::EDGetTokenT<TrajectoryCollection> trajsToken_;  //used to select what trajectories to read from configuration file
